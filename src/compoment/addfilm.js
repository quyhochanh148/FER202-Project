...
export default function AddMovie() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Logic for adding a new movie, e.g., sending data to a server
        console.log('New movie details:', movie);
    };
            ...
            <Row>
                ...
                <Col md={9} className="content-col content-col1">
                    <Card className="shadow-sm shadow-sm1 rounded">
                        <Card.Header as="h2" className="text-center">Add New Movie</Card.Header>
                        <Card.Body>
                            <Form onSubmit={handleSubmit}>
                                <Row>
                                    <Col md={4} className="text-center">
                                        <Image src={movie.poster || 'https://placehold.co/200x300?text=No+Image'} className="movie-poster" rounded style={{ width: "200px", height: "300px" }} />
